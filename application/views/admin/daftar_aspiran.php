        ...
        <div id="content-wrapper">
            ...
            <div class="card mb-3">
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                    <?php foreach($aspiran as $aspirans): ?>
                        <tr>
                        <td><?php echo $aspirans ->nama ?></td>
                        <td><?php echo $aspirans ->email ?></td>
                        <td><?php echo $aspirans ->no_hp ?></td>
                        <td style="text-align: center;">
                            <a class="btn btn-primary submit" title="Edit Akun" style="color:white;" 
                                href="<?php echo site_url('admin/edit_aspiran/'.$aspirans->id_akun) ?>">
                                <i class="fa fa-edit"></i></a>
                            <a onclick="deleteConfirm('<?php echo site_url('admin/delete_aspiran/'.$aspirans->id_akun) ?>')" 
